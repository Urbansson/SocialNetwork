...
@NamedQueries({
    ...
    @NamedQuery(name = "TPost.findByrecievingwall", query = "SELECT t FROM TPost t WHERE t.recievingwall = :user ORDER BY t.publishtime DESC")})
public class TPost implements Serializable {
    ...
    public String toString() {
        return "se.social.persist.TPost[ postId=" + postId + " ]";
    }
